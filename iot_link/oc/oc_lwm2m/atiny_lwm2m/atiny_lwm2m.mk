...
ifeq ($(USE_FOTA), y)
        ...
        $(filter-out $(iot_link_root)/oc/oc_lwm2m/atiny_lwm2m/atiny_fota_manager.c \
        $(iot_link_root)/oc/oc_lwm2m/atiny_lwm2m/atiny_fota_state.c \
        $(iot_link_root)/oc/oc_lwm2m/atiny_lwm2m/firmware_update.c, $(OC_LWM2M_AGENT_SRC))
