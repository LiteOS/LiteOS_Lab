...
RTK8710_SOCKET_IMP_SOURCE  = ${wildcard $(TOP_DIR)/iot_link/network/tcpip/rtk8710_socket/*.c}
C_SOURCES += $(RTK8710_SOCKET_IMP_SOURCE)
		
RTK8710_SOCKET_IMP_INC = -I $(TOP_DIR)/iot_link/network/tcpip/rtk8710_socket
