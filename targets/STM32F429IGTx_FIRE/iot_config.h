...
#define CONFIG_OC_MQTTV5_BS_ENABLE 1
#define CONFIG_OC_MQTTV5_TLS_BIDIRECTION 1
#define CONFIG_SHELL_ENABLE 1
#define CONFIG_SHELL_TASK_STACKSIZE 4096
