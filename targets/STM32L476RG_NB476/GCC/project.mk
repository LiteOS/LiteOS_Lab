...
HARDWARE_SRC =  \
        ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/Src/*.c} \
        ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/OLED/*.c} \
        ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/DHT11/*.c}
...
USER_SRC =  \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/main.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/system_stm32l4xx.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/stm32l4xx_it.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/sys_init.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/usart.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/uart_debug.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/dwt.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/i2c.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/gpio.c\
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/rtc.c \
        $(TOP_DIR)/targets/STM32L476RG_NB476/Src/LWM2M_Task.c
        C_SOURCES += $(USER_SRC)  
        
ifeq ($(CONFIG_AT_ENABLE),y)
    UART_AT_SRC = $(TOP_DIR)/targets/STM32L476RG_NB476/uart_at/uart_at.c
    C_SOURCES += $(UART_AT_SRC)
endif

 OS_CONFIG_INC = \
        -I $(TOP_DIR)/targets/STM32L476RG_NB476/OS_CONFIG
...
HARDWARE_INC = \
        -I ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/Inc} \
        -I ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/OLED} \
        -I ${wildcard $(TOP_DIR)/targets/STM32L476RG_NB476/Hardware/DHT11}
        C_INCLUDES += $(HARDWARE_INC)

USER_INC = \
        -I $(TOP_DIR)/targets/STM32L476RG_NB476/Inc \
        -I $(TOP_DIR)/targets/STM32L476RG_NB476
        C_INCLUDES += $(USER_INC)
        
# C defines
C_DEFS +=  -D USE_HAL_DRIVER -D STM32L476xx -D NDEBUG

include $(TOP_DIR)/targets/STM32L476RG_NB476/Demos/user_demo.mk
