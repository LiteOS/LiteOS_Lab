...
#example for LiteOS func
	...
	#example for os_interrupt_demo 
	ifeq ($(CONFIG_USER_DEMO), "os_interrupt_demo")	
		user_demo_src  = ${wildcard $(TARGET_DIR)/Demos/os_interrupt_demo/*.c}
		user_demo_defs = -D CONFIG_INTERRUPT_ENABLE=1
	endif
