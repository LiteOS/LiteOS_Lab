...
ifeq ($(CONFIG_DEMO_TYPE), "none")	
	...
	ifeq ($(CONFIG_USER_DEMO), "hello_world_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi_OS_Func/Demos/hello_world_demo
	...
	ifeq ($(CONFIG_USER_DEMO), "osal_task_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi_OS_Func/Demos/osal_task_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif
	...
	ifeq ($(CONFIG_USER_DEMO), "osal_mem_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi_OS_Func/Demos/osal_mem_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif
	...
	ifeq ($(CONFIG_USER_DEMO), "osal_semp_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi_OS_Func/Demos/osal_semp_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif
	...
	ifeq ($(CONFIG_USER_DEMO), "osal_mutex_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi_OS_Func/Demos/osal_mutex_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif

	#example for osal_queue_demo	 
	ifeq ($(CONFIG_USER_DEMO), "osal_queue_demo")	
		user_demo_src  = ${wildcard $(TOP_DIR)/targets/STM32L431_BearPi/Demos/osal_queue_demo/*.c}
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi/Demos/osal_queue_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif
	...
	ifeq ($(CONFIG_USER_DEMO), "osal_timer_demo")	
		...
		user_demo_inc = -I $(TOP_DIR)/targets/STM32L431_BearPi/Demos/osal_timer_demo
		user_demo_defs = -D CONFIG_HELLO_WORLD_ENABLE=1
	endif
