...
#define RCU_AHBEN_SRAMEN            BIT(2)                    /*!< SRAM interface clock enable */
#define RCU_AHBEN_FMCEN             BIT(4)                    /*!< FMC clock enable */
...
typedef enum
{
    ...
    RCU_SRAM    = RCU_REGIDX_BIT(IDX_AHBEN, 2U),                  /*!< SRAM clock */
    RCU_FMC     = RCU_REGIDX_BIT(IDX_AHBEN, 4U),                  /*!< FMC clock */
