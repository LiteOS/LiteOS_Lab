...
/*
	...
	LCD_DC:		PB14
*/
#define	LCD_PWR(n)	(n?gpio_bit_set(GPIOC, GPIO_PIN_7):gpio_bit_reset(GPIOC, GPIO_PIN_7))
#define	LCD_RST(n)	(n?gpio_bit_set(GPIOC, GPIO_PIN_6):gpio_bit_reset(GPIOC, GPIO_PIN_6))
#define	LCD_DC(n)		(n?gpio_bit_set(GPIOA, GPIO_PIN_6):gpio_bit_reset(GPIOA, GPIO_PIN_6))
