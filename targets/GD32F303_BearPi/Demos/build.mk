...
#example for lwm2m
	...
	ifeq ($(CONFIG_USER_DEMO), "oc_streetlight_template")
		...
		ifeq ($(CONFIG_OC_LWM2M_TYPE), "boudica150_oc")
			user_demo_src  = ${wildcard $(TARGET_DIR)/Demos/oc_streetlight_template/oc_streetlight_template.c}
			user_demo_inc = -I $(TARGET_DIR)/Demos/oc_streetlight_template
		endif

		ifeq ($(CONFIG_OC_LWM2M_TYPE), "soft")
			user_demo_src  = ${wildcard $(TARGET_DIR)/Demos/oc_streetlight_template/oc_streetlight_template_Agent.c}
			user_demo_inc = -I $(TARGET_DIR)/Demos/oc_streetlight_template
		endif
